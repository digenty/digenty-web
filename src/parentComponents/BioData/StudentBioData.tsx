...
const viewMock = {
  ...
  lastName: "John",
  avatar: null,
  admissionNum: "ADM/2015/23232",
  gender: "Male",
  dateOfBirth: "30 June, 2009",
  fields: [
    { icon: MapPin, label: "Home Address", value: "14 Lekki Phase 1, Lagos State" },
    { icon: FirstAidKit, label: "Medical Information", value: "NIL" },
    ...
    { icon: FirstAidKit, label: "Emergency Contact Name", value: "+234 803 456 7890" },
    { icon: FirstAidKit, label: "Emergency Contact Number", value: "+234 803 456 7890" },
  ],
};
      ...
      <div className="bg-bg-muted flex items-center justify-between px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <p className="text-text-default text-sm font-semibold">
            {viewMock.firstName} {viewMock.lastName}
          </p>
        </div>
        <Button
          size="sm"
      ...
      <div className="bg-bg-card w-full rounded-lg">
        <div className="border-border-default grid grid-cols-2 border-b md:grid-cols-3">
          <div className="flex flex-col gap-3 px-4 py-2">
            ...
            <p className="text-text-default text-sm font-medium">{viewMock.admissionNum}</p>
          </div>
          <div className="border-border-default flex flex-col gap-2 border-l px-4 py-3 md:border-r">
            ...
            <p className="text-text-default text-sm font-medium"> {viewMock.gender}</p>
          </div>
          <div className="border-border-default col-span-2 flex flex-col gap-2 border-t px-4 py-3 md:col-span-1 md:border-none">
            ...
            <p className="text-text-default text-sm font-medium"> {viewMock.dateOfBirth}</p>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-3 md:gap-6">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <div className="flex flex-col gap-2">
                ...
                <Input placeholder="Damilare John" className="bg-bg-input-soft! h-8 w-full rounded-md border-none text-sm" />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input placeholder="0000000000" className="bg-bg-input-soft! h-8 w-full rounded-md border-none text-sm" />{" "}
              </div>
            </div>
          </div>
        </div>
