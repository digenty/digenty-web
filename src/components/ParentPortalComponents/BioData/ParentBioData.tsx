        ...
        <div className="bg-bg-muted flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-text-subtle text-xs">{data?.relationship}</p>
            </div>
          </div>
          <Button
            size="sm"
        ...
        <div className="bg-bg-card w-full rounded-lg">
          <div className="border-border-default flex items-center gap-3 border-b px-4 py-3 last:border-b-0">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-text-default text-sm font-medium">{data?.phoneNumber}</p>
            </div>
          </div>
          ...
          <div className="border-border-default flex items-center gap-3 border-b px-4 py-3 last:border-b-0">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-text-default text-sm font-medium">{data?.secondaryPhoneNumber}</p>
            </div>
          </div>
          ...
          <div className="border-border-default flex items-center gap-3 border-b px-4 py-3 last:border-b-0">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-text-default text-sm font-medium">{data?.address}</p>
            </div>
          </div>
          ...
          <div className="border-border-default flex items-center gap-3 border-b px-4 py-3 last:border-b-0">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-text-default text-sm font-medium">{data?.gender}</p>
            </div>
          </div>
          ...
          <div className="border-border-default flex items-center gap-3 border-b px-4 py-3 last:border-b-0">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-text-default text-sm font-medium">{data?.branch}</p>
            </div>
          </div>
        </div>
      </div>
