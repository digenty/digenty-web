...
import { Country, StudentInputValues } from "@/components/StudentAndParent/types";
...
export const EditStudentBiodata = ({ onSave, onCancel, data }: { data: { data: Student } | undefined; onSave: () => void; onCancel: () => void }) => {
  ...
  useEffect(() => {
    if (data && branches) {
      const brnch = branches.find((brnch: BranchLookup) => brnch.name === data.data.branch);
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="border-border-default grid grid-cols-1 gap-3 border-b pb-3 md:grid-cols-2 md:gap-6 md:pb-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Select disabled={!values.nationality} value={values.stateOfOrigin} onValueChange={v => setFieldValue("stateOfOrigin", v)}>
                    <SelectTrigger
