...
import { AttendanceMgtWrapper } from "./AttendanceMgtWrapper";
    ...
    <AttendanceMgtWrapper isLoading={isLoading}>
      <div className="flex flex-col">
        ...
        <div className="space-y-6 px-4 pt-4 pb-8 md:space-y-7.5 md:px-8 md:pt-6 md:pb-12">
          ...
          <SearchInput
            className="bg-bg-input-soft! w-full rounded-md border-none md:w-80"
            value={searchQuery}
            onChange={evt => {
