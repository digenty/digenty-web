...
export const InvoiceIdBreakDownTable = () => {
  ...
  return (
    <div>
      {!isMobile ? (
        <div className="border-border-default h-full w-full border p-6">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            {breakdownData.map(breakdown => (
              <div key={breakdown.id} className="border-border-default bg-bg-state-ghost flex flex-col rounded-sm border">
...
export const InvoiceIdPaymentHistoryTable = () => {
  ...
  return (
    <div>
      {!isMobile ? (
        <div className="md:border-border-default md:rounded-sm md:border md:p-6">
          <div className="text-text-default text-md mb-6 font-semibold">Payment History</div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {paymentHistoryData.map(history => (
                <div key={history.id} className="border-border-default bg-bg-state-ghost flex flex-col rounded-sm border">
                  <div className="border-border-default border-b">
                    <div className="flex items-center justify-between px-3 py-2">
