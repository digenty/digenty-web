    ...
    onSubmit: values => {
      mutate(
        ...
        },
        {
          onSuccess: data => {
            toast({
              title: `Successfully edited ${data.data.firstName} ${data.data.lastName}`,
    ...
    <div className="flex h-screen flex-col">
      ...
      <form noValidate onSubmit={formik.handleSubmit} className="text-text-default flex-1 px-4 pt-4 md:px-30 md:pt-8 xl:px-70">
        <div className="block md:hidden">
          ...
          {step === 3 && <AcademicInformation formik={formik} data={data} onAdmissionNumberGenerated={setGeneratedAdmissionNumber} />}
        ...
        <div className="hidden md:block">
          ...
          <AcademicInformation formik={formik} data={data} onAdmissionNumberGenerated={setGeneratedAdmissionNumber} />
