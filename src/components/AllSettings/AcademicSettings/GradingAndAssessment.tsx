...
import { GradingAndAssessmentSheet } from "./GradingAndAssessmentSheet";
    ...
    <div className="mx-auto flex w-full flex-col gap-4 px-4 lg:px-36">
      <div className="bg-bg-subtle border-border-default mb-5 flex w-full items-start justify-between rounded-md border p-4">
        <div className="">
          ...
          <div className="text-text-subtle text-sm font-normal">Turn ON for branch-specific assessment. Keep OFF to share one setup.</div>
        </div>
        <Toggle />
      </div>
...
export const ClassAssessmentSetup = () => {
  ...
  return (
    <div className="mx-auto mt-8 flex w-full flex-col gap-6">
      ...
      <div className="bg-bg-state-soft m overflow-x-auto rounded-md p-2">
