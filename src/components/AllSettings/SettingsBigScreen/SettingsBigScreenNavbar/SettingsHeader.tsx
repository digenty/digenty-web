...
export const SettingsHeader = () => {
  ...
  return (
    <nav className="border-border-default hide-scrollbar hidden h-14 w-screen items-center justify-between gap-2 overflow-x-auto border-b px-8 py-3 pr-24 md:flex">
