...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (!isUserLoading && user.permissions && !hasAccess) {
      router.replace(getFirstAccessibleStaffRoute(user.permissions));
    }
  }, [isUserLoading, user.permissions, hasAccess, router]);
