...
export const AllBranchDetailsColumns: ColumnDef<AllBranchesTableProps>[] = [
...

  {
    ...
    cell: ({ row }) => <span className="text-text-default text-sm font-medium">{row.original.numberOfClassArm || 0}</span>,
    size: 100,
  },
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="text-text-default text-sm font-medium">{row.original.numberOfPendingApprovals || 0}</div>,
    size: 140,
  },
