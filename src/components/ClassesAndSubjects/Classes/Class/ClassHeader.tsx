        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:p-4">
          ...
          <div className="border-border-default space-between flex items-center gap-2 border-b px-4 pb-2 md:gap-1 md:border-none md:p-0">
            <Button
              ...
              className="bg-bg-state-secondary border-border-default text-text-default flex hidden h-8 w-46 items-center gap-1 rounded-md border text-sm font-medium md:flex"
            >
            ...
            <DropdownMenu open={open} onOpenChange={setOpen}>
              <DropdownMenuTrigger
                ...
                className="bg-bg-state-secondary border-border-default text-text-default block flex h-8 w-8 cursor-pointer content-center items-center justify-center rounded-md border focus-visible:ring-0 focus-visible:outline-none md:hidden"
              >
