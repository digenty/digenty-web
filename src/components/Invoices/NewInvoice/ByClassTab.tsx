    ...
    <>
      {students.map(s => {
        ...
        return (
          ...
          >
            <Checkbox
              checked={selectedKeys.has(recipientKey(r))}
          ...
          {loadingBranches ? (
            ...
            branches.map(b => {
              ...
              return (
                <div
                  key={b.branch.id}
                  className={rowClass(activeBranch?.branch.id === b.branch.id)}
                  onClick={() => {
                    setActiveBranch(b);
        ...
        <div className="overflow-y-auto">
          {levels.length === 0 ? (
            ...
            levels.map(l => (
              <div
                key={l.id}
                className={rowClass(activeLevelId === l.id)}
                onClick={() => {
          ...
          {!activeLevelId ? (
            ...
            classes.map(c => {
              ...
              return (
                <div
                  key={c.classId}
                  className={rowClass(activeClass?.classId === c.classId)}
                  onClick={() => {
                    setActiveClass(c);
                    setActiveArmId(null);
                  }}
