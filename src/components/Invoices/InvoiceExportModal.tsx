  ...
  const filterContent = (
    <div className="flex w-full flex-col gap-4 px-6 py-4">
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className="bg-bg-input-soft! text-text-default h-9 w-full rounded-md border-none px-3 py-2 text-left text-sm font-normal">
            <SelectValue>
              <span className="text-text-default text-sm">
                {classesList.find(c => c.id === selectedClassId)?.name ?? "All Classes"}
              </span>
            </SelectValue>
          </SelectTrigger>
          <SelectContent className="bg-bg-default border-border-default">
            <SelectItem value="none" className="text-text-default text-sm">All Classes</SelectItem>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={selectedTermId ? String(selectedTermId) : "none"}
          onValueChange={v => setSelectedTermId(v === "none" ? undefined : Number(v))}
        >
          <SelectTrigger className="bg-bg-input-soft! text-text-default h-9 w-full rounded-md border-none px-3 py-2 text-left text-sm font-normal">
            <SelectValue>
          ...
          <SelectContent className="bg-bg-default border-border-default">
            <SelectItem value="none" className="text-text-default text-sm">All Terms</SelectItem>
