    ...
    onSubmit: values => {
      ...
      createFeeGroup(
        ...
        },
        {
          ...
          onError: (err: unknown) => {
            const msg = (err as { message?: string })?.message ?? "Failed to create fee group";
            toast.error(msg);
          },
        },
      );
          ...
          <Table className="w-full rounded-md">
            <TableHeader className="bg-bg-input-soft text-text-muted text-xs font-medium">
              <TableRow className="border-border-default flex h-10 w-full flex-row gap-2 border-b py-3">
                ...
                <TableHead className="w-full max-w-20 text-left">Qty</TableHead>
                <TableHead className="w-full max-w-30 text-left">Unit Price</TableHead>
            ...
            <TableBody className="[&_tr:first-child]:pt-5">
              {items.map(item => (
                <TableRow key={item.id} className="flex w-full flex-row items-center gap-2 border-none px-4 py-2">
                  ...
                  <td className="bg-bg-input-soft h-8! w-full max-w-20 rounded-md">
                    <Input
                      type="number"
                      min={1}
                      value={item.qty}
                  ...
                  <td className="bg-bg-input-soft h-8! w-full max-w-30 rounded-md px-2">
                  ...
                  <td className="flex w-full items-center justify-between gap-2">
                    <div className="bg-bg-input-soft flex h-8 w-full cursor-not-allowed items-center gap-2 rounded-md px-2">
                      <span className="text-text-muted text-sm">₦</span>
