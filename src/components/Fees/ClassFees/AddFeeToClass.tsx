        ...
        <div className="px-4 py-4 md:px-8">
          <div className="border-border-default mx-auto flex flex-col gap-6">
                          ...
                          {sheetFees.map(sf => (
                            <div key={sf.id} className="border-border-darker bg-bg-card w-85 rounded-md border p-4 md:w-full md:min-w-118">
                              <div className="flex w-full items-start gap-2.5">
                                <Image src="/staff/images/image.png" alt="no image" width={32} height={32} className="rounded-full" />
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input className="bg-bg-input-soft! text-text-muted rounded-md border-none text-sm" placeholder="Input Fee Name" />
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="w-full">
                ...
                <Input className="bg-bg-input-soft! text-text-muted rounded-md border-none text-sm" placeholder="₦ 0.00" />
              </div>
            </div>
          ...
          <div className="border-border-default bg-bg-default fixed bottom-0 w-full max-w-150 border-t py-3 pr-8 pl-4 md:px-0">
            <div className="flex w-full justify-between">
              <Button className="bg-bg-state-soft! text-text-subtle! hover:bg-bg-state-soft-hover! h-8! text-sm">Cancel</Button>
              <div className="flex items-center gap-2">
                <Button className="bg-bg-state-soft! text-text-subtle! hover:bg-bg-state-soft-hover! hidden h-8! text-sm md:flex">
                  Save & Add Another
                </Button>
                <Button className="bg-bg-state-primary! hover:bg-bg-state-primary-hover! text-text-white-default h-8!">Add Fee</Button>
              </div>
            </div>
          </div>
        </div>
