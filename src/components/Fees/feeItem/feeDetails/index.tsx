...
export const FeeItemDetail = () => {
  return (
    <div className="flex items-center justify-center px-4 py-3 md:px-8">
      <div className="mx-auto flex w-full max-w-225 flex-col gap-6">
        ...
        <div className="border-border-default grid grid-cols-2 rounded-sm border md:grid-cols-4">
          <div className="border-border-default flex flex-col gap-4 border-r border-b p-6 md:border-b-0">
          ...
          <div className="border-border-default flex flex-col gap-4 border-r p-6">
        ...
        {/*  */}
        <div className="border-border-default flex w-full flex-col gap-6 rounded-sm border p-6">
        ...
        {/* Apply */}
        <div className="border-border-default rounded-sm border p-6">
            ...
            <div key={branch.title} className="mb-6">
              ...
              <div className="flex flex-col gap-3">
                {branch.classes.map(cls => (
                  <div key={cls.className} className="bg-bg-subtle flex w-full items-center justify-between rounded-md p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-bg-badge-default border-border-default text-text-subtle h-5! rounded-md border text-sm">{cls.type}</Badge>
                    </div>
